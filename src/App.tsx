...
function App() {
  ...
  function Modal() {
    ...
    return (
      <div className="modal fixed top-0 right-0 bottom-0 left-0 flex items-center  justify-center z-10 bg-gray-900 bg-opacity-75">
        <div className="bg-gray-900 dark:bg-white p-4 h-screen w-full animate-slide-down">
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className="flex bg-grey-900 dark:bg-white flex-col items-center justify-center h-screen p-4">
        <div className="fondo"></div>
        <div className="container h-4/5 md:flex">
          <div className="image md:w-1/2 flex justify-center z-10">
            <img
          ...
          <div className="md:w-1/2 self-center px-4 md:px-0">
            <div>
              <h1 className="text-5xl font-bold leading-10 text-orange-600 hover:underline mt-4 mb-2 pl-14 relative">
                ...
                <span className="block text-white dark:text-gray-950 pt-2">
                  FRONTEND DEVELOPER
                </span>
              </h1>
              <p className="text-base text-white dark:text-gray-950 leading-9 mt-4 mb-6">
                I'm a software developer, my forte is frontend development, in
                the last years I've been preparing myself and continue learning
                new skills mostly with react and javascript. I try to keep a
                curious mentality of wanting to learn more every day, my goal is
                to become a fullstack developer.
              </p>
            </div>
          </div>

          <div className="icons p-4 justify-end mt-8 md:mt-0 md:flex md:justify-center z-[100] relative">
            <button
              className="fixed top-4 right-4 p-2 rounded-full bg-gray-500 dark:bg-gray-800 z-50"
